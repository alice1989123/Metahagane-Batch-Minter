...
module.exports.make_daedalus_bootstrap_witness = function (
  ...
  var ret = wasm.make_daedalus_bootstrap_witness(
    tx_body_hash.ptr,
    addr.ptr,
    key.ptr
  );
...
module.exports.make_icarus_bootstrap_witness = function (
  ...
  var ret = wasm.make_icarus_bootstrap_witness(
    tx_body_hash.ptr,
    addr.ptr,
    key.ptr
  );
...
module.exports.get_implicit_input = function (
  ...
  var ret = wasm.get_implicit_input(
    txbody.ptr,
    pool_deposit.ptr,
    key_deposit.ptr
  );
 ...
 * @returns {BigNum}
 */
module.exports.min_ada_required = function (
  assets,
  minimum_utxo_val,
  data_hash
) {
...
class BootstrapWitness {
  ...
  static new(vkey, signature, chain_code, attributes) {
    ...
    var len1 = WASM_VECTOR_LEN;
    var ret = wasm.bootstrapwitness_new(
      vkey.ptr,
      signature.ptr,
      ptr0,
      len0,
...
class Certificate {
  ...
  static new_stake_deregistration(stake_deregistration) {
    ...
    var ret = wasm.certificate_new_stake_deregistration(
  ...
  static new_genesis_key_delegation(genesis_key_delegation) {
    ...
    var ret = wasm.certificate_new_genesis_key_delegation(
  ...
  static new_move_instantaneous_rewards_cert(move_instantaneous_rewards_cert) {
    ...
    var ret = wasm.certificate_new_move_instantaneous_rewards_cert(
...
class GeneralTransactionMetadata {
  ...
  insert(key, value) {
    ...
    var ret = wasm.generaltransactionmetadata_insert(
      this.ptr,
      key.ptr,
      value.ptr
    );
...
class GenesisKeyDelegation {
  ...
  static new(genesishash, genesis_delegate_hash, vrf_keyhash) {
    ...
    var ret = wasm.genesiskeydelegation_new(
      genesishash.ptr,
...
class MoveInstantaneousRewardsCert {
  ...
  move_instantaneous_reward() {
    var ret = wasm.moveinstantaneousrewardscert_move_instantaneous_reward(
      this.ptr
    );
    return MoveInstantaneousReward.__wrap(ret);
  }
  ...
  static new(move_instantaneous_reward) {
    ...
    var ret = wasm.moveinstantaneousrewardscert_new(
...
class OperationalCert {
  ...
  static new(hot_vkey, sequence_number, kes_period, sigma) {
    ...
    var ret = wasm.operationalcert_new(
      hot_vkey.ptr,
      sequence_number,
      kes_period,
      sigma.ptr
...
class ProposedProtocolParameterUpdates {
  ...
  insert(key, value) {
    ...
    var ret = wasm.proposedprotocolparameterupdates_insert(
      this.ptr,
      key.ptr,
      value.ptr
    );
...
class SingleHostAddr {
  ...
  static new(port, ipv4, ipv6) {
    ...
    var ret = wasm.singlehostaddr_new(
...
class SingleHostName {
  ...
  static new(port, dns_name) {
    ...
    var ret = wasm.singlehostname_new(
      isLikeNone(port) ? 0xffffff : port,
      dns_name.ptr
    );
    return SingleHostName.__wrap(ret);
...
class TransactionBody {
  ...
  static new(inputs, outputs, fee, ttl) {
    ...
    var ret = wasm.transactionbody_new(
      inputs.ptr,
      outputs.ptr,
      fee.ptr,
      !isLikeNone(ttl),
      isLikeNone(ttl) ? 0 : ttl
    );
    return TransactionBody.__wrap(ret);
  }
}
...
class TransactionBuilder {
  ...
  add_key_input(hash, input, amount) {
    ...
    wasm.transactionbuilder_add_key_input(
      this.ptr,
      hash.ptr,
      input.ptr,
      amount.ptr
  ...
  add_script_input(hash, input, amount) {
    ...
    _assertClass(input, TransactionInput);
    _assertClass(amount, Value);
    wasm.transactionbuilder_add_script_input(
      this.ptr,
      hash.ptr,
      input.ptr,
      amount.ptr
  ...
  add_bootstrap_input(hash, input, amount) {
    ...
    _assertClass(input, TransactionInput);
    _assertClass(amount, Value);
    wasm.transactionbuilder_add_bootstrap_input(
      this.ptr,
      hash.ptr,
      input.ptr,
      amount.ptr
  ...
  add_input(address, input, amount) {
    ...
    _assertClass(input, TransactionInput);
    _assertClass(amount, Value);
    wasm.transactionbuilder_add_input(
      this.ptr,
      address.ptr,
      input.ptr,
      amount.ptr
  ...
  fee_for_input(address, input, amount) {
    ...
    _assertClass(input, TransactionInput);
    _assertClass(amount, Value);
    var ret = wasm.transactionbuilder_fee_for_input(
      this.ptr,
      address.ptr,
      input.ptr,
      amount.ptr
  ...
  set_required_signers(required_signers) {
    _assertClass(required_signers, Ed25519KeyHashes);
    wasm.transactionbuilder_set_required_signers(
      this.ptr,
      required_signers.ptr
    );
  }
  /**
   * @param {AuxiliaryData} auxiliary_data
  ...
  add_change_if_needed(address) {
    _assertClass(address, Address);
    var ret = wasm.transactionbuilder_add_change_if_needed(
      this.ptr,
      address.ptr
    );
    return ret !== 0;
...
module.exports.__wbg_getRandomValues_1ef11e888e5228e9 = function (
  arg0,
  arg1,
  arg2
) {
...
module.exports.__wbg_randomFillSync_1b52c8482374c55b = function (
  arg0,
  arg1,
  arg2
) {
